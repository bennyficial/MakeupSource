...
function open(url) {
	$('#new-window-container').fadeIn();
	$('#iframe').attr('src', url);
	 $('#newWindow').fadeIn();
};
function close() {
	$('#new-window-container').fadeOut();
	 $('#newWindow').fadeOut();
};
$(document).ready(function() {
...
$('.drop').hover(function () {
  $(this).find('.brand').stop(true, true).delay(200).fadeIn();
}, function () {
  $(this).find('.brand').stop(true, true).delay(200).fadeOut();
});
//
